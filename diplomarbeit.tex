...
\chapter{Individuelle Zielsetzung}
    ...
    \section{Software}
    	\subsubsection{Initialisierungen}
    	...
    	\subsubsection{Control Area Network}
    	...
    	\subsubsection{Serial Peripheral Interphase}
    	\subsubsection{ADC/DAC Einstellungen}
...
\chapter{Ergebnisse}
	...
	\section{Software}
		...
		Um die Gewünschte Funktionalität des Mikrocontrollers zu aktivieren müssen vor dem Eigentlichen Programmablauf alle Peripherie und auch interne Funktionen erst initialisiert werden. Dies wird mittels Bitschieben in den einzelnen Registern gemacht.
		...
		\subsection{Control Area Network}
